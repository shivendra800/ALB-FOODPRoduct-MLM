...
@section('content')
    ...
    <div class="container" style="padding:2rem;">
        <div class="tab-content translations-content-item en visible" id="en">
            ...
            <p>Last updated on Jul 28th 2023</p>
            <p>
            ...
            <p>
                Welcome to our website. If you continue to browse and use this website you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern ALB FOOD PRODUCTS''s relationship with you in relation to this website.  
            </p>
            <p>
                The term 'ALB FOOD PRODUCTS' or 'us' or 'we' refers to the owner of the website whose registered/operational office is HOUSE NO.- 479, KUCHESAR ROAD CHOPLA, FATHAPUR HAPUR Hapur UTTAR PRADESH 245201. The term 'you' refers to the user or viewer of our website.
           ...
           <p>
            ...
            <ul>
                ...
                <li>
                    <p> You may not create a link to this website from another website or document without ALB FOOD PRODUCTS’s prior written consent.
                    </p>
                </li>
                <li>
