...
<footer class="footer-section">
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-4 mb-30">
                        <div class="single-cta">
                            <i class="fa fa-map"  style="color:#008DE2;"></i>
                            <div class="cta-text">
                                <h4>Find us</h4>
                                <span>FATHAPUR, Uttar Pradesh, 245201</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-4 mb-30">
                        <div class="single-cta">
                            <i class="fa fa-phone" style="color:#008DE2;"></i>
                            <div class="cta-text">
                                <h4>Call us</h4>
                                <span>8077636670</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-4 mb-30">
                        <div class="single-cta">
                            <i class="fa fa-envelope-open" style="color:#008DE2;"></i>
                            <div class="cta-text">
                                <h4>Mail us</h4>
                                <span>info@albfoodproducts.in</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-4 col-lg-4 mb-50">
                        <div class="footer-widget">
                            <div class="footer-logo">
                                <a href="index.html"><img src="https://i.ibb.co/Hnm1ZJC/logos2.png" class="img-fluid" alt="logo"></a>
                            </div>
  ...
  <div class="social_icons ">
    ...
    <a href="#" class="social_icons--link social_icons--link-twitter" target="_blank">
      <svg class="social_icons--icon icon icon-twitter" fill="#1DA1F2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
    ...
    <a href="#" class="social_icons--link social_icons--link-google_plus" target="_blank">
      <svg class="social_icons--icon icon icon-googleplus" fill="#DC4E41" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                        <div class="footer-widget">
                            ...
                            <ul id="footlinks">
                                ...
                                <li><a href="{{url('/')}}/policy">Our Policy</a></li>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 mb-50">
                        <div class="footer-widget">
                            ...
                            <div class="subscribe-form">
                                <form action="#">
                                    <input type="text" placeholder="Email Address" id="mailcontact">
                                    <input type="button" class="btn btn-danger " id="mailcontactbtn"  value="SEND" style="margin-top:.5rem;width:100%;border-radius:0px; background-color:#008DE2;"/>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-5 text-center text-lg-left">
                        <div class="copyright-text">
                            <p>Copyright &copy; 2023, All Right Reserved <a href="/"  style="color:#008DE2;">ALB Food Products</a></p>
                        </div>
                    </div>
