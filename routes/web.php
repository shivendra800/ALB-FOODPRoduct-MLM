...
// phone pe url 
Route::any('phonepe-response','App\Http\Controllers\Checkoutcontroller@PhonepeResponse');
...
Route::middleware(['auth','isAdmin'])->group(function (){
    ...
    Route::get('stockUpdate-history','App\Http\Controllers\Admin\ProductController@stockUpdatehistory');
        ...
        Route::get('/Order-Not-Placed','App\Http\Controllers\Admin\OrderController@OrderNotPlaced');
    ...
    Route::get('/DeliveryBoy-Dashboard','App\Http\Controllers\Admin\DeliveryBoyDashboardController@dashboard');
     ...
     //  Ecom APi All That work here----------------------------------------------------
    Route::get('Ecom-Login-Data','App\Http\Controllers\Admin\EcomController@EcomLoginData');

    Route::get('Shipment-Track','App\Http\Controllers\Admin\EcomController@ShipmentTrack');
    Route::post('shipment-track-view','App\Http\Controllers\Admin\EcomController@ShipmentTrackSearch');

    Route::get('FetchAWB-No','App\Http\Controllers\Admin\EcomController@FetchAWB');
    Route::post('FetchAWB-No-view','App\Http\Controllers\Admin\EcomController@FetchAWBNoSearch');

    Route::get('SERVICEABILITY','App\Http\Controllers\Admin\EcomController@SERVICEABILITY');
    Route::post('SERVICEABILITY-view','App\Http\Controllers\Admin\EcomController@SERVICEABILITYSearch');

    Route::get('Shipment-Cancellation','App\Http\Controllers\Admin\EcomController@ShipmentCancellation');
    Route::post('shipment-Cancellation-view','App\Http\Controllers\Admin\EcomController@ShipmentCancellationSearch');
