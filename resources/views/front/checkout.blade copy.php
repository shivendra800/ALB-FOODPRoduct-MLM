                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @if ($cartItem->count() > 0)
                                ...
                                {{-- <button class="btn btn-primary  w-100 mt-3 razorpay-btn btn-submit" style="border-radius:0px;" type="button">Pay With Razorpay</button> --}}


                                    {{-- phone pe --}}
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="payment_mode" id="flexRadioDefault1" value="COD">
                                        <label class="form-check-label" for="flexRadioDefault1">
                                          COD
                                        </label>
                                      </div>
                                      <div class="form-check">
                                        <input class="form-check-input" type="radio" name="payment_mode" id="flexRadioDefault2" value="Phone-Pe">
