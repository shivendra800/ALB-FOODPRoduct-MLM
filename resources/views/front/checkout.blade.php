                        ...
                        <div class="card-body">
                            ...
                            <div class="row checkout-form">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control firstname" @if(Auth::user()->name != null) value="{{ Auth::user()->name }}" @else value="{{old('fname')}}" @endif
                                        name="fname" id="" placeholder="Enter First Name" required>
                                    <span id="fname_error" class="text-danger"></span>
                                </div>
                                <div class="col-md-6">
                                    <label for="">Last Name</label>
                                    <input type="text" class="form-control lastname" @if(Auth::user()->lname != null) value="{{ Auth::user()->lname }}" @else value="{{old('lname')}}" @endif 
                                        name="lname" id="" placeholder="Enter Last Name" required>
                                    <span id="lname_error" class="text-danger"></span>
                                </div>
                                <div class="col-md-6">
                                    <label for="">Phone Number</label>
                                    <input type="number" class="form-control phone" @if(Auth::user()->phone != null) value="{{ Auth::user()->phone }}" @else value="{{old('phone')}}" @endif 
                                        name="phone" id="" placeholder="Enter Phone Number" required>
                                    <span id="phone_error" class="text-danger"></span>
                                </div>
                                <div class="col-md-6">
                                    <label for="">Email</label>
                                    <input type="text" class="form-control email" @if(Auth::user()->email != null) value="{{ Auth::user()->email }}" @else value="{{old('email')}}" @endif  
                                        name="email" id="" placeholder="Enter Email" required>
                                    <span id="email_error" class="text-danger"></span>
                                </div>
                                <div class="col-md-6">
                                    <label for="">Address 1</label>
                                    <input type="text" class="form-control address1" @if(Auth::user()->address1 != null) value="{{ Auth::user()->address1 }}" @else value="{{old('address1')}}" @endif  
                                        name="address1" id="" placeholder="Enter Address 1" required>
                                    <span id="address1_error" class="text-danger"></span>
                                </div>
                                <div class="col-md-6">
                                    <label for="">Address 2</label>
                                    <input type="text" class="form-control address2" @if(Auth::user()->address2 != null) value="{{ Auth::user()->address2 }}" @else value="{{old('address2')}}" @endif  
                                ...
                                <div class="col-md-6">
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control area" @if(Auth::user()->area != null) value="{{ Auth::user()->area }}" @else value="{{old('area')}}" @endif  
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control pincode"
                                         @if(Auth::user()->pincode != null) value="{{ Auth::user()->pincode }}" @else value="{{old('pincode')}}" @endif  name="pincode" id=""
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select name="payment_mode" id="payment_mode"  class="form-control">
                                                    ...
                                                    <option @if (old('payment_mode') == 'COD') selected @endif  value="COD">COD</option>
                                                    <option @if (old('payment_mode') == 'Phone-Pe') selected @endif value="Phone-Pe">Phone-Pe</option>
                                                </select>
