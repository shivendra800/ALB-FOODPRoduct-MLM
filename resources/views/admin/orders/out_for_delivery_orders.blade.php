...
@section('title', 'Out For Delivery Orders')
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                                 <span style="color:#007bff">Out For Delivery</span> Orders</div>
...
<script type="text/javascript">
    function exportExcelPending()
    {
        ...
        window.open("{{ url('/') }}/OutForDelivery-orders-Report-Excel/"+start_date+"/"+end_date+"/"+payment_status, '_self');
    }
    }
</script>
